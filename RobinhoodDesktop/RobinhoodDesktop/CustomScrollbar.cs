...
namespace CustomControls {
    ...
    public class CustomScrollbar : UserControl {
        ...
        public CustomScrollbar() {
            ...
            UpArrowImage = System.Drawing.Bitmap.FromFile("Content/GUI/uparrow.png"); ;
            DownArrowImage = System.Drawing.Bitmap.FromFile("Content/GUI/downarrow.png"); ;
            

            ThumbBottomImage = System.Drawing.Bitmap.FromFile("Content/GUI/ThumbBottom.png"); ;
            ThumbBottomSpanImage = System.Drawing.Bitmap.FromFile("Content/GUI/ThumbMiddle.png"); ;
            ThumbTopImage = System.Drawing.Bitmap.FromFile("Content/GUI/ThumbTop.png"); ;
            ThumbTopSpanImage = System.Drawing.Bitmap.FromFile("Content/GUI/ThumbSpanTop.png"); ;
            ThumbMiddleImage = System.Drawing.Bitmap.FromFile("Content/GUI/ThumbSpanBottom.png"); ;
        ...
        public int Value {
            ...
            set
            {
                int prevValue = moValue;
                moValue = value;

                if((UpArrowImage == null) || (DownArrowImage == null)) return;
                ...
                if (nRealRange != 0)
                {
                    fPerc = Math.Min(1.0f, (float)moValue / (float)nRealRange);
                }
            
                float fTop = fPerc * nPixelRange;
                moThumbTop = (int)fTop;

                if(prevValue != moValue)
                {
        ...
        private void InitializeComponent() {
            ...
            this.MouseWheel += new System.Windows.Forms.MouseEventHandler(this.CustomScrollbar_MouseWheel);
        ...
        {
            Value = Math.Max(0, (-e.Delta / 5) + Value);
        }
